...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #
    primary.item :menu_categories, 'Categories', categories_path, highlights_on: %r(/categories)

    # Add an item which has a sub navigation (same params, but with block)
    primary.item :menu_products, 'Products', products_path, highlights_on: %r(/products)
